...
enum
{
	...
	I2C_MEM_WDT_POWER_OFF_INTERVAL_GET_ADD = I2C_MEM_WDT_POWER_OFF_INTERVAL_SET_ADD
		+ 4,
    I2C_MEM_DIAG_3V3_MV_ADD = I2C_MEM_WDT_POWER_OFF_INTERVAL_GET_ADD + 4,
	I2C_MEM_DIAG_RASP_V = I2C_MEM_DIAG_3V3_MV_ADD + 2,
	I2C_MEM_DIAG_VIN = I2C_MEM_DIAG_RASP_V + 2,
	I2C_MEM_DIAG_TEMPERATURE_ADD = I2C_MEM_DIAG_VIN + 2,//one byte temperature in degC
